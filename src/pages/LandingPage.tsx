        ...
        <section className="py-32 bg-[#0d0d0d] relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <a href="https://x.com/Sinagithub" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-white transition-colors">
                <SiX className="w-3.5 h-3.5" /> @Sinagithub
              </a>
